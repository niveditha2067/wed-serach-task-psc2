...
class WebCrawler:
    ...
    # Define this BEFORE the main block
...
if __name__ == "__main__":
    ...
    # Option 1: Use dummy data instead of crawling
    crawler.index["https://example.com/page1"] = "this page has a keyword"
    crawler.index["https://example.com/page2"] = "this does not"
